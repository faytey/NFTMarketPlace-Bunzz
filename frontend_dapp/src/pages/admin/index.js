...
const Admin = () => {
  ...
  const { data: setAdminData, write: setAdmin } =
    useContractWrite(setAdminConfig);
  ...
  const { data: removeAdminData, write: removeAdmin } =
    useContractWrite(removeAdminConfig);
  ...
  const { data: listingFeeData, write: listingFeeWrite } =
    useContractWrite(listingFeeConfig);
  ...
  const { data: whitelistAddrData, write: whitelistAddrWrite } =
    useContractWrite(whitelistAddrConfig);
  ...
  const { data: withdrawLPData, write: withdrawLPWrite } =
    useContractWrite(withdrawLPConfig);
      ...
      {isAdmin ? (
        <div className="grid grid-cols-1 md:grid-cols-2 m-0 p-8 gap-5 h-full">
          <div className="border m-0 p-8 gap-5 rounded-lg">
            ...
            <button
              className="border m-0 p-3 rounded-lg"
              onClick={(e) => {
                e.preventDefault();
                withdrawWrite?.();
              }}
          ...
          <div className="border m-0 p-8 gap-5 rounded-lg ">
            ...
            <div className="flex flex-col m-0 p-3 gap-3">
              ...
              <input
                type="text"
                className="text-black m-0 p-2 rounded-lg"
                placeholder="Admin address"
                onChange={(e) => {
                  setSetAdminAddr(e.target.value);
                }}
              />
              <button
            ...
            <div className="flex flex-col m-0 p-3 gap-3">
              ...
              <input
                ...
                onChange={(e) => {
                  setListingFee(ethers.utils.parseEther(e.target.value));
                }}
              />
              <button
                className="m-0 p-2 border rounded-lg"
            ...
            <div className="flex flex-col m-0 p-3 gap-3">
              ...
              <input
                ...
                onChange={(e) => {
                  setWhitelistAddr(e.target.value);
                }}
              />
              <button
                className="m-0 p-2 border rounded-lg"
        ...
        <p className="w-full h-full m-0 p-16 text-center">
