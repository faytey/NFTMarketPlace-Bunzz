...
letsviewNFTs();
  ...
  return (
    <main className="mt-6 mb-6" style = {{transition:"3s ease-in-out"}}>
      ...
      <div style={{fontSize:"120%",}}>Nft Marketplace Ui Created With Anima For Figma. Collect, Buy And Sell Art From More Than 20k Nft Artists.</div>
      <button class="mt-8 font-bold py-4 px-8 rounded-full"
      style={{transition:"1s ease-in-out",background:"#0044ee",}} id="homeButton"><Link href={"/marketplace"}>Get Started</Link>
           </button>
      ...
      <div className = "mt-4 pb-8" id="secondHomeSection" style={{paddingLeft:"12%", paddingRight:"12%", fontSize:"120%"}}>
        ...
        <div className="mt-10 grid grid-cols-3 gap-8">
          <div className='grid-col-1' >
            ...
            <div style={{fontSize:"120%", fontWeight:"bold"}}>Dsgn Animals</div>
            <div className='grid grid-cols-5'>
            <div className='grid-col-1'><img src="././assets/finegirl.png" className='rounded-full' id="smallestpics" /></div>
            <div className='=grid-cols-4' style={{marginLeft:"-30%"}} >MrFox</div>
            </div>
            </div>
          <div className='grid-col-1'>
            ...
            <div className='grid grid-cols-3 mt-5 gap-5'>
              <div className='grid-cols-1'><img src="././assets/firstsetimagesub1.png" id="firstpicsetsub"/></div>
              <div className='grid-cols-1'><img src="././assets/firstsetimagesub2.png" id="firstpicsetsub"/></div>
              <div className='grid-cols-1' id = "firstpicsetsubtext">1025+</div>
            </div>
            <div style={{fontSize:"120%", fontWeight:"bold"}}>Magic Mushrooms</div>
            <div className='grid grid-cols-5'>
            <div className='grid-col-1'><img src="././assets/finegirl.png" className='rounded-full' id="smallestpics"/></div>
            <div className='=grid-cols-4' style={{marginLeft:"-30%"}} >Shroomie</div>
            </div>
            </div>
          <div className='grid-col-1' >
            ...
            <div style={{fontSize:"120%", fontWeight:"bold"}}>Disco Machines</div>
            <div className='grid grid-cols-5'>
            <div className='grid-col-1'><img src="././assets/finegirl.png" className='rounded-full' id="smallestpics"/></div>
            <div className='=grid-cols-4' style={{marginLeft:"-30%"}} >BeKind2Robots</div>
            </div>
            </div>
          </div> 
         </div>
      ...
      <div className='grid grid-cols-2 mb-10'>
        <div className='grid-cols-1' style={{fontSize:"120%"}}>
          <div style={{fontSize:"160%", fontWeight:"bold"}}>Top Creators</div>
      ...
      <div className='grid-cols-1 text-center' id="thirdsectiontopcreators" style={{backgroundColor:"#444444", borderRadius:"8%", paddingBottom:"6%"}}>
        <img src="././assets/firstsetimagesub1.png" className='rounded-full sm:ml-4' style={{transform:"scale3d(0.6,0.6,0.6)",marginTop:"-7%"}}/>
        <div className="font-bold" style={{fontSize:"130%", marginTop:"-10%"}}>keepitreal</div>
      ...
      <div className='' style={{fontSize:"180%", fontWeight:"bold"}}>Browse Categories</div>
      <div className="grid grid-cols-4 gap-8 mb-4" >
        <div className='grid-cols-1' id="fourthsectioncategories" style={{backgroundColor:"#444444", borderRadius:"8%", paddingBottom:"10%", marginTop:"10%", transition:"1s ease-in-out"}}>
          <img src="././assets/DistantGalaxy.png" />
          <div style={{fontSize:"130%", fontWeight:"bold", marginTop:"5%", paddingLeft:"10%"}}>Art</div>
        </div>
        <div className='grid-cols-1' id="fourthsectioncategories" style={{backgroundColor:"#444444", borderRadius:"8%", paddingBottom:"10%", marginTop:"10%", transition:"1s ease-in-out"}}>
          <img src="././assets/DistantGalaxy.png" />
          <div style={{fontSize:"130%", fontWeight:"bold", marginTop:"5%", paddingLeft:"10%"}}>Collectibles</div>
        </div>
        <div className='grid-cols-1' id="fourthsectioncategories" style={{backgroundColor:"#444444", borderRadius:"8%", paddingBottom:"10%", marginTop:"10%", transition:"1s ease-in-out"}}>
          <img src="././assets/DistantGalaxy.png" />
          <div style={{fontSize:"130%", fontWeight:"bold", marginTop:"5%", paddingLeft:"10%"}}>Music</div>
        </div>
        <div className='grid-cols-1' id="fourthsectioncategories" style={{backgroundColor:"#444444", borderRadius:"8%", paddingBottom:"10%", marginTop:"10%", transition:"1s ease-in-out"}}>
          <img src="././assets/DistantGalaxy.png" />
          <div style={{fontSize:"130%", fontWeight:"bold", marginTop:"5%", paddingLeft:"10%"}}>Photography</div>
        </div>
      </div>
      <div className="grid grid-cols-4 gap-8 mb-4" >
        <div className='grid-cols-1' id="fourthsectioncategories" style={{backgroundColor:"#444444", borderRadius:"8%", paddingBottom:"10%", marginTop:"10%", transition:"1s ease-in-out"}}>
      ...
      <div className='grid grid-cols-2 mb-10'>
        <div className='grid-cols-1' style={{fontSize:"120%"}}>
          <div style={{fontSize:"160%", fontWeight:"bold"}}>Discover More Nfts</div>
      ...
      <div className="grid grid-cols-3 gap-8 mb-4" >
        <div className='grid-cols-1' id="fifthsectioncontainers" style={{backgroundColor:"#444444", borderRadius:"8%", paddingBottom:"10%", marginTop:"10%", transition:"1s ease-in-out"}}>
          <img src="././assets/finegirl.png" />
          <div style={{fontSize:"130%", fontWeight:"bold", marginTop:"5%", paddingLeft:"10%"}}>Distant Galaxy</div>
          <div className='grid grid-cols-4' style={{marginTop:"2%", paddingLeft:"10%"}} >
            <div className='grid-cols-1' ><img src="././assets/Avatar.png" className='rounded-full' style={{height:"100%", width:"50%", transform:""}}/></div>
            <div className='grid-cols-3' style={{marginLeft:"-25%", marginTop:"10%"}}>MoonDancer</div>
          </div>
          <div className='grid grid-cols-2' style={{paddingLeft:"10%", paddingRight:"10%", marginTop:"5%"}}>
            <div className='grid-cols-1'>
              <div style={{fontSize:"80%", color:"#bbbbbb", fontFamily:"georgia"}}>Price</div>
              <div>1.63 ETH</div>
            </div>
            <div className='grid-cols-1' >
            <div style={{float:"right",fontSize:"80%", color:"#aaaaaa", fontFamily:"georgia"}}>Highest Bid</div><br></br>
        ...
        <div className='grid-cols-1' id="fifthsectioncontainers" style={{backgroundColor:"#444444", borderRadius:"8%", paddingBottom:"10%", marginTop:"10%", transition:"1s ease-in-out"}}>
          ...
          <div style={{fontSize:"130%", fontWeight:"bold", marginTop:"5%", paddingLeft:"10%"}}>Economy</div>
          <div className='grid grid-cols-4' style={{marginTop:"2%", paddingLeft:"10%"}} >
            <div className='grid-cols-1' ><img src="././assets/Avatar.png" className='rounded-full' style={{height:"100%", width:"50%", transform:""}}/></div>
            <div className='grid-cols-3' style={{marginLeft:"-25%", marginTop:"10%"}}>Spaceone</div>
          </div>
          <div className='grid grid-cols-2' style={{paddingLeft:"10%", paddingRight:"10%", marginTop:"5%"}}>
            <div className='grid-cols-1'>
              <div style={{fontSize:"80%", color:"#bbbbbb", fontFamily:"georgia"}}>Price</div>
        ...
        <div className='grid-cols-1' id="fifthsectioncontainers" style={{backgroundColor:"#444444", borderRadius:"8%", paddingBottom:"10%", marginTop:"10%", transition:"1s ease-in-out"}}>
          ...
          <div style={{fontSize:"130%", fontWeight:"bold", marginTop:"5%", paddingLeft:"10%"}}>Astrofiction</div>
          <div className='grid grid-cols-4' style={{marginTop:"2%", paddingLeft:"10%"}} >
            <div className='grid-cols-1' ><img src="././assets/Avatar.png" className='rounded-full' style={{height:"100%", width:"50%", transform:""}}/></div>
            <div className='grid-cols-3' style={{marginLeft:"-25%", marginTop:"10%"}}>Fantasy</div>
          </div>
          <div className='grid grid-cols-2' style={{paddingLeft:"10%", paddingRight:"10%", marginTop:"5%"}}>
            <div className='grid-cols-1'>
              <div style={{fontSize:"80%", color:"#bbbbbb", fontFamily:"georgia"}}>Price</div>
     ...
     <div className='' id="sixthhomesection" style={{marginTop:"5%", backgroundImage:"url(././assets/mushroom2.png)",
      paddingTop:"20%", paddingBottom:"5%", backgroundSize:"100%"}}>
       <div className='grid grid-cols-2' style={{paddingRight:"12%", paddingLeft:"12%"}}>
        ...
        <div className='mt-3' style={{fontSize:"300%", fontWeight:"bold"}}>Magic Mashrooms Auction</div>
        ...
        <div className='grid-cols-1'>
          <div className='float-right' id="timerparagraph"><div id="countdown"></div></div>
        </div>
      </div>
     </div>
     ...
     <div className='' style={{fontSize:"120%"}}>
          <div style={{fontSize:"160%", fontWeight:"bold"}}>How It Works</div>
          <div>Find Out How To Get Started</div>
        </div>
      <div className='grid grid-cols-3 gap-8' style={{marginTop:"4%"}} >
        <div className='grid-cols-1' style={{backgroundColor:"#444444", borderRadius:"8%", paddingBottom:"9%", paddingTop:"3%", textAlign:"center", paddingLeft:"10%", paddingRight:"10%",}}>
          <img src="././assets/icon.svg" className='rounded-full' style={{ transform:"scale3D(0.9,0.9,0.9)",}}/>
          <div style={{fontSize:"120%", fontWeight:"bold"}}>Setup Your Wallet</div>
          <div style={{paddingTop:"3%"}}>Set up your wallet of choice. Connect it to the Animarket by clicking the wallet icon in the top right corner.</div>
        </div>
        <div className='grid-cols-1' style={{backgroundColor:"#444444", borderRadius:"8%", paddingBottom:"9%", paddingTop:"3%", textAlign:"center", paddingLeft:"10%", paddingRight:"10%",}}>
          <img src="././assets/icon.svg" className='rounded-full' style={{ transform:"scale3D(0.9,0.9,0.9)",}}/>
          <div style={{fontSize:"120%", fontWeight:"bold"}}>Create Collection</div>
          <div style={{paddingTop:"3%"}}>Upload your work and setup your collection. Add a description, social links and floor price.</div>
        </div>
        <div className='grid-cols-1' style={{backgroundColor:"#444444", borderRadius:"8%", paddingBottom:"9%", paddingTop:"3%", textAlign:"center", paddingLeft:"10%", paddingRight:"10%",}}>
          <img src="././assets/icon.svg" className='rounded-full' style={{ transform:"scale3D(0.9,0.9,0.9)",}}/>
          <div style={{fontSize:"120%", fontWeight:"bold"}}>Start Earning</div>
          <div style={{paddingTop:"3%"}}>Choose between auctions and fixed-price listings. Start earning by selling your NFTs or trading others.</div>
        </div>
       </div>
     </div>
