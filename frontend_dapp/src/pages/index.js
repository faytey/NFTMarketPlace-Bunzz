...
export default function Home() {
  return (
    <main className="mt-6 " style = {{backgroundImage:"linear-gradient(20deg, blue, green, red)"}}>
      ...
      style={{transition:"1s ease-in-out",background:"#a244ff", hover:"transform:scale3d(0.8,0.8,0.8)",}}>
      Get Started
      </button>
      ...
      <img src="././assets/benz.jpg" className = "" style={{transition:"5s ease-in-out",
       boxShadow:"15px 15px 10px 2px rgba(20,20,20,0.9)", animation:"homepicanimation 5s alternate infinite",
       animation:"homepicanimation2 3s alternate infinite",borderRadius:"" }} />
      </div>
