  ...
  return (
    <div className="m-0 p-5">
      <div className="flex flex-col items-start justify-start gap-3">
        <div className="rounded-xl flex flex-row items-start justify-start gap-3 text-4xl md:text-8xl">
          <div className="rounded-xl flex flex-col items-start justify-start">
            ...
            <div className="relative text-lg leading-[140%] font-caption-work-sans">
