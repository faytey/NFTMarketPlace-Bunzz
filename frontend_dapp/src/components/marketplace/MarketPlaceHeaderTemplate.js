    ...
    <div className="m-0 p-8">
          <div className=" shrink-0 flex flex-col items-start justify-start gap-[30px]">
            ...
            <div className="flex">
              ...
              <input placeholder='Search your favourite NFTs' className='border relative rounded-full p-3 pl-8 placeholder:text-white bg-[#A259FF] bg-opacity-30 w-full' />
            </div>

            <div className="flex w-full items-center justify-center text-3xl gap-16">
              <Link className="relative font-semibold border-b-2 border-[#A259FF]" href={"/marketplace/listitem"}>List Item</Link>
              <Link className="relative font-semibold border-b-2 border-[#A259FF]" href={"/launchpad"}>Create LauchPad</Link>
            </div>
          </div>
    </div>
  );
